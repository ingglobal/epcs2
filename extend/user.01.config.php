...
define('G5_USER_ADMIN_COMDATA_PATH',   		G5_ADMIN_PATH.'/'.G5_USER_ADMIN_DIR.'/comdata');
define('G5_USER_ADMIN_COMDATA_URL',   		G5_ADMIN_URL.'/'.G5_USER_ADMIN_DIR.'/comdata');
...
$g5['customer_saler_table']         = NEW_TABLE_PREFIX.'customer_saler';
